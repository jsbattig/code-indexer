...
class SearchEngine:
    ...
    def search_by_file(self, file_path: str, limit: int = 10) -> List[SearchResult]:
        """Search for content within a specific file."""
        filter_conditions = {"must": [{"key": "path", "match": {"value": file_path}}]}
    ...
    def search_by_language(
        self, language: str, query: Optional[str] = None, limit: int = 10
    ) -> List[SearchResult]:
