...
class DockerManager:
    ...
    def __init__(self, console: Optional[Console] = None, project_name: Optional[str] = None):
    ...
    def create_compose_file(self, data_dir: Path = Path(".code-indexer")) -> None:
        ...
        compose_config = {
            ...
            "networks": {
                "default": {
                    "name": f"code-indexer-{self.project_name}"
                }
            }
        }
    ...
    def start_services(self, recreate: bool = False) -> bool:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                self.console.print(f"❌ Failed to start services: {result.stderr}", style="red")
                return False
    ...
    def stop_services(self) -> bool:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                self.console.print(f"❌ Failed to stop services: {result.stderr}", style="red")
                return False
    ...
    def ollama_request(self, endpoint: str, method: str = "GET", data: Optional[Dict] = None) -> Dict[str, Any]:
    ...
    def qdrant_request(self, endpoint: str, method: str = "GET", data: Optional[Dict] = None) -> Dict[str, Any]:
