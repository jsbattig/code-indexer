...
class TextChunker:
    ...
    def _fallback_split(self, text: str) -> List[str]:
        ...
        while start < len(text):
            ...
            start = break_point - self.chunk_overlap if break_point > start + self.chunk_overlap else break_point
        
        return chunks
    
    def chunk_text(self, text: str, file_path: Optional[Path] = None) -> List[Dict[str, Any]]:
