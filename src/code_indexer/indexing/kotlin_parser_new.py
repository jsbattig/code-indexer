...
class KotlinSemanticParser(BaseTreeSitterParser):
    ...
    def _fallback_parse(self, content: str, file_path: str) -> List[SemanticChunk]:
        ...
        from .kotlin_parser import KotlinSemanticParser as OriginalKotlinParser

        original_parser = OriginalKotlinParser(self.config)
    ...
    def _handle_function_declaration(
        ...
        if function_name:
            ...
            construct_type = "extension_function" if receiver else "function"
