...
class GitSyncExecutor:
    ...
    def create_backup(self) -> BackupResult:
        ...
        try:
            ...
            logger.info(f"Backup created: {backup_path} ({files_backed_up} files)")
    ...
    def configure_ssh_auth(self, ssh_key_path: str, passphrase: Optional[str] = None):
        ...
        logger.info(f"SSH authentication configured with key: {ssh_key_path}")
    ...
    def configure_https_auth(self, token: str):
        ...
        logger.info("HTTPS token authentication configured")
    ...
    def _execute_git_pull(self, merge_strategy: str) -> str:
        ...
        try:
            ...
            logger.info(f"Git pull completed successfully: {result.stdout[:200]}...")
    ...
    def _trigger_cidx_index(self) -> bool:
        ...
        try:
            ...
            if not vector_store_client.health_check():
                logger.error("Vector store client health check failed")
                return False
    ...
    def restore_from_backup(self, backup_path: str) -> bool:
        ...
        try:
            ...
            logger.info(f"Repository restored from backup: {backup_path}")
            return True
