...
async def git_reset(
    ...
    try:
        ...
        logger.warning(f"Confirmation required for {alias}: {e}")
...
async def git_merge_abort(
    ...
    try:
        ...
        logger.warning(f"Repository not found or no merge in progress: {alias}")
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=str(e))
    except Exception as e:
...
async def git_checkout_file(
    ...
    try:
        ...
        logger.warning(f"Repository or file not found: {alias}/{request.file_path}")
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=str(e))
    except Exception as e:
...
async def git_branch_create(
    ...
    try:
        ...
        logger.warning(f"Branch already exists: {alias}/{request.branch_name}")
...
async def git_branch_switch(
    ...
    try:
        ...
        logger.warning(f"Repository or branch not found: {alias}/{name}")
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=str(e))
    except Exception as e:
