...
class GitResetRequest(BaseModel):
    ...
    commit_hash: Optional[str] = Field(None, description="Target commit hash (optional)")
    confirmation_token: Optional[str] = Field(None, description="Confirmation token for destructive operations")
...
class GitResetResponse(BaseModel):
    ...
    requires_confirmation: Optional[bool] = Field(None, description="Whether confirmation is required")
...
class GitCleanResponse(BaseModel):
    ...
    success: Optional[bool] = Field(None, description="Operation success status")
    removed_files: Optional[List[str]] = Field(None, description="List of removed files")
    requires_confirmation: Optional[bool] = Field(None, description="Whether confirmation is required")
    token: Optional[str] = Field(None, description="Confirmation token if required")
