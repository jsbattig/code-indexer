...
class TestAC1_MCPBExtraction:
    ...
    def test_extracts_mcpb_exe(self, nsis_script_content):
        ...
        assert re.search(
            r'File\s+"[^"]*cidx-semantic-search\.exe"', nsis_script_content
        )
    ...
    def test_creates_directory_structure(self, nsis_script_content):
        ...
        assert re.search(
            r'(CreateDirectory|SetOutPath)\s+"C:\\\\mcpb', nsis_script_content
        )
...
class TestAC2_AuthenticationGUI:
    ...
    def test_has_server_url_input(self, nsis_script_content):
        ...
        assert re.search(
            r"(nsDialogs::Create(Control|Text)|\$\{NSD_CreateText\})",
            nsis_script_content,
            re.IGNORECASE,
        )
    ...
    def test_has_password_input(self, nsis_script_content):
        ...
        assert re.search(
            r"(ES_PASSWORD|PASSWORD|Secure)", nsis_script_content, re.IGNORECASE
        )
    ...
    def test_has_field_validation(self, nsis_script_content):
        ...
        assert re.search(
            r"(StrCmp|StrLen|Validate)", nsis_script_content, re.IGNORECASE
        )
    ...
    def test_has_default_server_url(self, nsis_script_content):
        ...
        assert re.search(
            r"(!define\s+DEFAULT_SERVER_URL|StrCpy.*http)",
            nsis_script_content,
            re.IGNORECASE,
        )
...
class TestAC3_APIAuthentication:
    ...
    def test_handles_http_errors(self, nsis_script_content):
        ...
        assert re.search(
            r"(401|403|500|error|status)", nsis_script_content, re.IGNORECASE
        )
...
class TestAC4_MCPBConfiguration:
    ...
    def test_creates_mcpb_directory(self, nsis_script_content):
        ...
        assert re.search(
            r"(CreateDirectory|SetOutPath).*APPDATA.*\.mcpb",
            nsis_script_content,
            re.IGNORECASE,
        )
    ...
    def test_writes_config_file(self, nsis_script_content):
        ...
        assert re.search(
            r"(FileOpen|nsJSON::Serialize.*config\.json)",
            nsis_script_content,
            re.IGNORECASE,
        )
    ...
    def test_handles_write_failures(self, nsis_script_content):
        ...
        assert re.search(
            r"(IfErrors|error.*write|write.*fail)", nsis_script_content, re.IGNORECASE
        )
...
class TestAC5_ClaudeDesktopIntegration:
    ...
    def test_reads_existing_config(self, nsis_script_content):
        ...
        assert re.search(
            r"claude_desktop_config\.json", nsis_script_content, re.IGNORECASE
        )
    ...
    def test_preserves_existing_servers(self, nsis_script_content):
        ...
        assert re.search(
            r"(nsJSON::Get|merge|preserve)", nsis_script_content, re.IGNORECASE
        )
    ...
    def test_handles_missing_claude_desktop(self, nsis_script_content):
        ...
        assert re.search(
            r"(IfFileExists|warning|optional)", nsis_script_content, re.IGNORECASE
        )
...
class TestAC6_SilentInstallation:
    ...
    def test_supports_command_line_params(self, nsis_script_content):
        ...
        assert re.search(
            r"(GetOptions|GetParameters|/SERVER_URL|/USERNAME|/PASSWORD)",
            nsis_script_content,
            re.IGNORECASE,
        )
    ...
    def test_writes_to_log_file(self, nsis_script_content):
        ...
        assert re.search(
            r"(LogSet|LogText|DetailPrint|log)", nsis_script_content, re.IGNORECASE
        )
...
class TestAC7_ErrorHandling:
    ...
    def test_includes_context_in_errors(self, nsis_script_content):
        ...
        assert re.search(
            r"MessageBox.*(\$ServerUrl|\$INSTDIR|url|path)",
            nsis_script_content,
            re.IGNORECASE,
        )
    ...
    def test_provides_recovery_guidance(self, nsis_script_content):
        ...
        assert re.search(
            r"(retry|check|verify|ensure)", nsis_script_content, re.IGNORECASE
        )
    ...
    def test_logs_detailed_errors(self, nsis_script_content):
        ...
        assert re.search(
            r"(LogText|DetailPrint).*error", nsis_script_content, re.IGNORECASE
        )
...
class TestUninstallerAC1_InstallationDirectoryRemoval:
    ...
    def test_removes_installation_directory(self, nsis_script_content):
        ...
        assert re.search(
            r'RMDir\s+/r\s+"\$INSTDIR"', nsis_script_content, re.IGNORECASE
        )
    ...
    def test_handles_locked_files(self, nsis_script_content):
        ...
        assert re.search(
            r"(locked|in use|close.*application)", nsis_script_content, re.IGNORECASE
        )
...
class TestUninstallerAC2_ConfigurationDirectoryRemoval:
    ...
    def test_removes_config_directory(self, nsis_script_content):
        ...
        assert re.search(
            r'RMDir\s+/r\s+"\$APPDATA\\\.mcpb"', nsis_script_content, re.IGNORECASE
        )
    ...
    def test_handles_missing_config_directory(self, nsis_script_content):
        ...
        assert re.search(
            r"IfFileExists.*APPDATA.*\.mcpb", nsis_script_content, re.IGNORECASE
        )

    def test_logs_config_removal(self, nsis_script_content):
        """Script logs configuration directory removal."""
        assert re.search(
            r"(LogText|DetailPrint).*[Cc]onfiguration.*remov",
            nsis_script_content,
            re.IGNORECASE,
        )
...
class TestUninstallerAC3_ClaudeDesktopConfigCleanup:
    ...
    def test_has_remove_mcpb_function(self, nsis_script_content):
        ...
        assert re.search(
            r"Function\s+un\.RemoveMcpbFromClaudeConfig", nsis_script_content
        )
    ...
    def test_reads_claude_config(self, nsis_script_content):
        ...
        assert re.search(
            r"un\.RemoveMcpbFromClaudeConfig.*claude_desktop_config\.json",
            nsis_script_content,
    ...
    def test_removes_only_mcpb_key(self, nsis_script_content):
        ...
        assert re.search(
            r"nsJSON::Delete.*mcpServers.*cidx-semantic-search",
            nsis_script_content,
            re.IGNORECASE,
        )
    ...
    def test_writes_updated_config(self, nsis_script_content):
        ...
        assert re.search(
            r"un\.RemoveMcpbFromClaudeConfig.*nsJSON::Serialize",
            nsis_script_content,
            re.IGNORECASE | re.DOTALL,
        )
        assert re.search(
            r"un\.RemoveMcpbFromClaudeConfig.*FileWrite",
            nsis_script_content,
            re.IGNORECASE | re.DOTALL,
        )
    ...
    def test_handles_missing_claude_config(self, nsis_script_content):
        ...
        assert re.search(
            r"un\.RemoveMcpbFromClaudeConfig.*IfFileExists.*claude_desktop_config",
            nsis_script_content,
            re.IGNORECASE | re.DOTALL,
        )
    ...
    def test_handles_missing_mcpb_entry(self, nsis_script_content):
        ...
        assert re.search(
            r"nsJSON::Get.*cidx-semantic-search", nsis_script_content, re.IGNORECASE
        )
...
class TestUninstallerAC4_AddRemoveProgramsIntegration:
    ...
    def test_writes_uninstaller_during_install(self, nsis_script_content):
        ...
        assert re.search(
            r'WriteUninstaller\s+"\$INSTDIR\\uninstall\.exe"',
            nsis_script_content,
            re.IGNORECASE,
        )
    ...
    def test_writes_registry_display_name(self, nsis_script_content):
        ...
        assert re.search(
            r"WriteRegStr.*Uninstall\\MCPB.*DisplayName",
            nsis_script_content,
            re.IGNORECASE,
        )
    ...
    def test_writes_registry_display_version(self, nsis_script_content):
        ...
        assert re.search(
            r"WriteRegStr.*Uninstall\\MCPB.*DisplayVersion",
            nsis_script_content,
            re.IGNORECASE,
        )
    ...
    def test_writes_registry_publisher(self, nsis_script_content):
        ...
        assert re.search(
            r"WriteRegStr.*Uninstall\\MCPB.*Publisher",
            nsis_script_content,
            re.IGNORECASE,
        )
    ...
    def test_writes_registry_uninstall_string(self, nsis_script_content):
        ...
        assert re.search(
            r"WriteRegStr.*Uninstall\\MCPB.*UninstallString",
            nsis_script_content,
            re.IGNORECASE,
        )
    ...
    def test_writes_registry_install_location(self, nsis_script_content):
        ...
        assert re.search(
            r"WriteRegStr.*Uninstall\\MCPB.*InstallLocation",
            nsis_script_content,
            re.IGNORECASE,
        )
    ...
    def test_writes_registry_no_modify(self, nsis_script_content):
        ...
        assert re.search(
            r"WriteRegDWORD.*Uninstall\\MCPB.*NoModify",
            nsis_script_content,
            re.IGNORECASE,
        )
    ...
    def test_writes_registry_no_repair(self, nsis_script_content):
        ...
        assert re.search(
            r"WriteRegDWORD.*Uninstall\\MCPB.*NoRepair",
            nsis_script_content,
            re.IGNORECASE,
        )
    ...
    def test_deletes_registry_key_on_uninstall(self, nsis_script_content):
        ...
        assert re.search(
            r"DeleteRegKey.*Uninstall\\MCPB", nsis_script_content, re.IGNORECASE
        )
...
class TestUninstallerAC5_ConfirmationPrompt:
    ...
    def test_logs_uninstall_actions(self, nsis_script_content):
        ...
        assert re.search(
            r'Section\s+"Uninstall".*DetailPrint',
            nsis_script_content,
            re.IGNORECASE | re.DOTALL,
        )
...
class TestUninstallerAC6_SilentUninstallation:
    ...
    def test_supports_silent_uninstall(self, nsis_script_content):
        ...
        assert re.search(
            r'Section\s+"Uninstall".*IfSilent',
            nsis_script_content,
            re.IGNORECASE | re.DOTALL,
        )
    ...
    def test_skips_messageboxes_in_silent_mode(self, nsis_script_content):
        ...
        uninstall_section = re.search(
            r'Section\s+"Uninstall".*?(?=^Section|^Function|\Z)',
            nsis_script_content,
    ...
    def test_sets_exit_code_on_success(self, nsis_script_content):
        ...
        assert re.search(
            r'Section\s+"Uninstall".*SetErrorLevel\s+0',
            nsis_script_content,
            re.IGNORECASE | re.DOTALL,
        )
    ...
    def test_sets_exit_code_on_failure(self, nsis_script_content):
        ...
        assert re.search(
            r'Section\s+"Uninstall".*SetErrorLevel\s+[12]',
            nsis_script_content,
            re.IGNORECASE | re.DOTALL,
        )
    ...
    def test_writes_to_log_during_uninstall(self, nsis_script_content):
        ...
        uninstall_section = re.search(
            r'Section\s+"Uninstall".*?(?=Section|\Z)',
            nsis_script_content,
            re.IGNORECASE | re.DOTALL,
        )
        if uninstall_section:
...
class TestUninstallerErrorHandling:
    ...
    def test_handles_directory_removal_failure(self, nsis_script_content):
        ...
        assert re.search(
            r"RMDir.*IfFileExists", nsis_script_content, re.IGNORECASE | re.DOTALL
        )
...
class TestUninstallerIntegration:
    ...
    def test_uninstaller_created_during_install(self, nsis_script_content):
        ...
        assert re.search(
            r'Section\s+"Install.*WriteUninstaller',
            nsis_script_content,
            re.IGNORECASE | re.DOTALL,
        )
    ...
    def test_uninstaller_location_matches_registry(self, nsis_script_content):
        ...
        write_uninstaller = re.search(
            r'WriteUninstaller\s+"([^"]+)"', nsis_script_content, re.IGNORECASE
        )
        # UninstallString value is quoted and may have escaped quotes
        uninstall_string = re.search(
            r'UninstallString"\s+"([^"]+uninstall\.exe[^"]*)"',
            nsis_script_content,
            re.IGNORECASE,
        )
