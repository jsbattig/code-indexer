...
class TestTestReorganizer:
    ...
    def test_categorize_integration_tests(self):
        ...
        # Performance tests
        perf_tests = reorganizer.categorize_test_file(
            "test_parallel_voyage_performance.py"
        )
    ...
    def test_categorize_e2e_tests(self):
        ...
        # Git workflow tests
        git_tests = reorganizer.categorize_test_file(
            "test_reconcile_comprehensive_e2e.py"
        )
        ...
        # Payload index tests
        payload_tests = reorganizer.categorize_test_file(
            "test_payload_indexes_focused_e2e.py"
        )
        ...
        search_tests = reorganizer.categorize_test_file(
            "test_semantic_search_capabilities_e2e.py"
        )
    ...
    def test_move_files_actual(self):
        ...
        assert (
            self.test_root / "unit" / "parsers" / "test_python_semantic_parser.py"
        ).exists()
        ...
        assert (
            self.test_root / "e2e" / "claude_integration" / "test_claude_e2e.py"
        ).exists()
...
'''
    ...
    def test_rollback_functionality(self):
        ...
        with patch.object(
            reorganizer, "reorganize_tests", side_effect=Exception("Simulated error")
        ):
