...
class TestHashPhaseCallbacksIncludeConcurrentFiles:
    ...
    def test_hash_initialization_callback_uses_slot_tracker_data(self):
        ...
        assert (
            "copy.deepcopy(hash_slot_tracker.get_concurrent_files_data())"
            in hash_init_section
            or "hash_slot_tracker.get_concurrent_files_data()" in hash_init_section
        ), (
    ...
    def test_hash_completion_callback_uses_slot_tracker_data(self):
        ...
        assert (
            "copy.deepcopy(hash_slot_tracker.get_concurrent_files_data())"
            in hash_complete_section
            or "hash_slot_tracker.get_concurrent_files_data()" in hash_complete_section
        ), (
