...
class TestGetAllIndexedFiles:
    ...
    def test_empty_collection_returns_empty_list(self, temp_store: FilesystemVectorStore):
    ...
    def test_returns_all_unique_file_paths(self, populated_store: FilesystemVectorStore):
    ...
    def test_multiple_chunks_same_file_deduplicates(self, temp_store: FilesystemVectorStore):
    ...
    def test_nonexistent_collection_returns_empty_list(self, temp_store: FilesystemVectorStore):
...
class TestGetFileIndexTimestamps:
    ...
    def test_empty_collection_returns_empty_dict(self, temp_store: FilesystemVectorStore):
    ...
    def test_returns_timestamps_for_all_files(self, populated_store: FilesystemVectorStore):
    ...
    def test_multiple_chunks_same_file_returns_latest_timestamp(self, temp_store: FilesystemVectorStore):
    ...
    def test_nonexistent_collection_returns_empty_dict(self, temp_store: FilesystemVectorStore):
...
class TestSampleVectors:
    ...
    def test_returns_requested_sample_size(self, populated_store: FilesystemVectorStore):
    ...
    def test_sample_size_larger_than_collection_returns_all(self, populated_store: FilesystemVectorStore):
    ...
    def test_sample_contains_full_vector_data(self, populated_store: FilesystemVectorStore):
...
class TestValidateEmbeddingDimensions:
    ...
    def test_empty_collection_returns_true(self, temp_store: FilesystemVectorStore):
        ...
        result = temp_store.validate_embedding_dimensions(collection_name, expected_dims=128)

        assert result is True

    def test_all_vectors_match_dimensions_returns_true(self, populated_store: FilesystemVectorStore):
        """Test that matching dimensions returns True."""
        collection_name = "test_collection"

        result = populated_store.validate_embedding_dimensions(collection_name, expected_dims=128)

        assert result is True

    def test_mismatched_dimensions_returns_false(self, temp_store: FilesystemVectorStore):
    ...
    def test_nonexistent_collection_returns_true(self, temp_store: FilesystemVectorStore):
        """Test that nonexistent collection returns True (vacuously valid)."""
        result = temp_store.validate_embedding_dimensions("nonexistent", expected_dims=128)
...
class TestHealthCheck:
    ...
    def test_accessible_filesystem_returns_true(self, temp_store: FilesystemVectorStore):
