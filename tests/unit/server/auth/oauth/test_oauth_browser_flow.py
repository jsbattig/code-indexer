...
class TestBrowserBasedOAuthFlow:
    ...
    def test_app(self, temp_dirs):
        ...
        test_user_manager.create_user("testuser", "ValidPassword123!", UserRole.NORMAL_USER)
    ...
    def registered_client(self, test_app):
        ...
        response = test_app.post("/oauth/register", json={
    ...
    # ============================================================================
    def test_get_authorize_returns_html_form(self, test_app, registered_client, pkce_pair):
        ...
        response = test_app.get("/oauth/authorize", params={
            "client_id": client_id,
    ...
    # ============================================================================
    def test_post_authorize_with_form_data_returns_redirect(self, test_app, registered_client, pkce_pair):
        """Test that POST /oauth/authorize with Form data returns 302 redirect to callback URL."""
        code_verifier, code_challenge = pkce_pair
        client_id = registered_client["client_id"]

        # POST form data to /oauth/authorize
        response = test_app.post("/oauth/authorize", data={
            "client_id": client_id,
            "redirect_uri": "https://claude.ai/oauth/callback",
            "code_challenge": code_challenge,
            "response_type": "code",
