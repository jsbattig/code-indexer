...
class TestOAuthCompleteFlowStory478:
    ...
    def test_app(self, temp_dirs, test_user):
        ...
        from code_indexer.server.auth.oauth.routes import router as oauth_router, get_user_manager, get_oauth_manager
    ...
    def test_complete_oauth_flow_all_endpoints(self, test_app, test_user):
        ...
        response = test_app.post("/oauth/authorize", json={
            "client_id": client_id,
        ...
        response = test_app.post("/oauth/revoke", json={
