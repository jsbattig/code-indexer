"""
E2E test infrastructure for Claude integration tests.

Provides shared infrastructure components for end-to-end testing of Claude integration
...
class TestProjectInventory(Enum):
    """Enumeration of predefined test project configurations for Claude integration."""

    CLAUDE_E2E = "claude_e2e"
    CLAUDE_PLAN_E2E = "claude_plan_e2e"
...
def _get_inventory_config(inventory: TestProjectInventory) -> Dict[str, Any]:
    ...
    inventory_configs = {
        TestProjectInventory.CLAUDE_E2E: {
            **base_config,
            "claude_integration": True,
            "query_enabled": True,
        },
        TestProjectInventory.CLAUDE_PLAN_E2E: {
            **base_config,
            "claude_integration": True,
...
def main():
    ...
    print("Hello from Claude integration test project!")
    return "success"
...
"""
    ...
    (src_path / "claude_features.py").write_text(
        """
def claude_query_function():
    \"\"\"Function for Claude query testing.\"\"\"
    return "claude_query_result"
