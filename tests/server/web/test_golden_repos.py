...
class TestGoldenRepoListDisplay:
    ...
    def test_golden_repos_table_columns(self, authenticated_client: TestClient):
        ...
        assert "path" in text_lower or "url" in text_lower, "Table should have Path/URL column"
...
class TestAddRepoForm:
    ...
    def test_add_repo_form_renders(self, authenticated_client: TestClient):
        ...
        assert 'name="repo_url"' in text.lower() or 'name="path"' in text.lower() or 'name="repo_path"' in text.lower(), (
            "Form should have path/URL field"
        )
        assert 'name="branch"' in text.lower() or 'name="default_branch"' in text.lower(), (
    ...
    def test_add_repo_success(
        ...
        assert "success" in text_lower or "submitted" in text_lower or "started" in text_lower, (
    ...
    def test_add_repo_invalid_path(
        ...
        assert "error" in text_lower or "invalid" in text_lower or "inaccessible" in text_lower, (
