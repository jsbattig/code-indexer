...
class TestDockerManager(unittest.TestCase):
    ...
    def test_project_name_sanitization(self):
        ...
        test_cases = [
            ...
            ("project__underscores", "project__underscores"),  # Multiple underscores preserved
        ...
        for input_name, expected in test_cases:
            ...
            self.assertEqual(
                result, 
                expected,
                f"Failed to sanitize '{input_name}'"
            )
    ...
    def test_compose_config_generation(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(
                ...
                "code-ollama-test-project"
            )
            self.assertEqual(
                services['qdrant']['container_name'],
                "code-qdrant-test-project"
            )
