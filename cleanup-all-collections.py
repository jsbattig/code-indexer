...
def cleanup_all_collections(project_root: Path = None) -> bool:
    ...
    try:
        ...
        try:
            ...
            console.print("🔍 Connected to Qdrant, listing all collections...", style="cyan")
            ...
            if os.getenv("FORCE_CLEANUP") != "1":
                ...
                console.print("🤖 FORCE_CLEANUP=1 detected, proceeding without confirmation", style="cyan")
            ...
            for collection in all_collections:
                try:
                    if qdrant_client.delete_collection(collection):
                        ...
                        console.print(f"   ❌ Failed to delete: {collection}", style="red")
                        failed_count += 1
            ...
            console.print(f"   ✅ Successfully deleted: {deleted_count} collections", style="green")
            if failed_count > 0:
                console.print(f"   ❌ Failed to delete: {failed_count} collections", style="red")
